...
RSpec.describe "recommendeduniversities/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit recommendeduniversity form" do
    render

    assert_select "form[action=?][method=?]", recommendeduniversity_path(@recommendeduniversity), "post" do
